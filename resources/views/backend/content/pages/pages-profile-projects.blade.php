        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><span class="fw-medium">Client: </span><span class="text-muted">Christian Jimenez</span></div>
            </div>
          </div>
          <div class="ms-auto">
        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><span class="fw-medium">Client: </span><span class="text-muted">Jeffrey Phillips</span></div>
            </div>
          </div>
          <div class="ms-auto">
            <div class="dropdown z-2">
        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><span class="fw-medium">Client: </span><span class="text-muted">Ricky McDonald</span></div>
            </div>
          </div>
          <div class="ms-auto">
            <div class="dropdown z-2">
        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><span class="fw-medium">Client: </span><span class="text-muted">Hulda Wright</span></div>
            </div>
          </div>
          <div class="ms-auto">
            <div class="dropdown z-2">
        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><span class="fw-medium">Client: </span><span class="text-muted">Jerry Greene</span></div>
            </div>
          </div>
          <div class="ms-auto">
            <div class="dropdown z-2">
        ...
        <div class="d-flex align-items-start">
          <div class="d-flex align-items-start">
            ...
            <div class="me-2 ms-1">
              ...
              <div class="client-info"><span class="fw-medium">Client: </span><span class="text-muted">Olive Strickland</span></div>
            </div>
          </div>
          <div class="ms-auto">
            <div class="dropdown z-2">
