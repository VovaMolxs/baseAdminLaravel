        ...
        <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column m-sm-3 m-0">
          <div class="mb-xl-0 mb-4">
            <div class="d-flex svg-illustration mb-4 gap-2 align-items-center">
              <div class="app-brand-logo demo">@include('backend._partials.macros',["height"=>22,"withbg"=>''])</div>
...
<!-- Offcanvas -->
@include('backend/_partials/_offcanvas/offcanvas-send-invoice')
@include('backend/_partials/_offcanvas/offcanvas-add-payment')
<!-- /Offcanvas -->
@endsection
