                ...
                <div class="sidebar-body px-4 pb-4">
                    <div class="my-4">
                        ...
                        <textarea id="chat-sidebar-left-user-about"
                                  class="form-control chat-sidebar-left-user-about mt-3" rows="4" maxlength="120">Dessert chocolate cake lemon drops jujubes. Biscuit cupcake ice cream bear claw brownie brownie marshmallow.</textarea>
                    </div>
                    <div class="my-4">
                  ...
                  <span class="switch-off"></span>
                    ...
                    <div class="d-flex mt-4">
                        <button class="btn btn-primary" data-bs-toggle="sidebar" data-overlay
                                data-target="#app-chat-sidebar-left">Logout
                        </button>
                    </div>
                </div>
            </div>
                        ...
                        <li class="chat-contact-list-item">
                            <a class="d-flex align-items-center">
                                ...
                                <div class="chat-contact-info flex-grow-1 ms-2">
                                    ...
                                    <p class="chat-contact-status text-muted text-truncate mb-0">If it takes long you
                        ...
                        <ul class="list-unstyled chat-history">
                            ...
                            <li class="chat-message chat-message-right">
                                <div class="d-flex overflow-hidden">
                                    <div class="chat-message-wrapper flex-grow-1">
                                        <div class="chat-message-text">
                                            <p class="mb-0">{{ config('variables.templateName') ? config('variables.templateName') : 'TemplateName' }}
                            ...
                            <li class="chat-message">
                                <div class="d-flex overflow-hidden">
                                    ...
                                    <div class="chat-message-wrapper flex-grow-1">
                                        <div class="chat-message-text">
                                            <p class="mb-0">Do you have design files
                                                for {{ config('variables.templateName') ? config('variables.templateName') : 'TemplateName' }}
                                                ?</p>
                                        </div>
                                        <div class="text-muted mt-1">
