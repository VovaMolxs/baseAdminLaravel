...
@include('backend/_partials/_modals/modal-add-new-cc')
@include('backend/_partials/_modals/modal-add-new-address')
@include('backend/_partials/_modals/modal-refer-earn')
@include('backend/_partials/_modals/modal-edit-user')
@include('backend/_partials/_modals/modal-enable-otp')
@include('backend/_partials/_modals/modal-share-project')
@include('backend/_partials/_modals/modal-create-app')
@include('backend/_partials/_modals/modal-two-factor-auth')
@include('backend/_partials/_modals/modal-select-payment-providers')
@include('backend/_partials/_modals/modal-select-payment-methods')
