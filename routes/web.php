...
use App\Http\Controllers\backend\apps\AcademyCourse;
use App\Http\Controllers\backend\apps\AcademyCourseDetails;
use App\Http\Controllers\backend\apps\AcademyDashboard;
use App\Http\Controllers\backend\apps\AccessPermission;
use App\Http\Controllers\backend\apps\AccessRoles;
use App\Http\Controllers\backend\apps\Calendar;
use App\Http\Controllers\backend\apps\Chat;
use App\Http\Controllers\backend\apps\EcommerceCustomerAll;
use App\Http\Controllers\backend\apps\EcommerceCustomerDetailsBilling;
use App\Http\Controllers\backend\apps\EcommerceCustomerDetailsNotifications;
use App\Http\Controllers\backend\apps\EcommerceCustomerDetailsOverview;
use App\Http\Controllers\backend\apps\EcommerceCustomerDetailsSecurity;
use App\Http\Controllers\backend\apps\EcommerceDashboard;
use App\Http\Controllers\backend\apps\EcommerceManageReviews;
use App\Http\Controllers\backend\apps\EcommerceOrderDetails;
use App\Http\Controllers\backend\apps\EcommerceOrderList;
use App\Http\Controllers\backend\apps\EcommerceProductAdd;
use App\Http\Controllers\backend\apps\EcommerceProductCategory;
use App\Http\Controllers\backend\apps\EcommerceProductList;
use App\Http\Controllers\backend\apps\EcommerceReferrals;
use App\Http\Controllers\backend\apps\EcommerceSettingsCheckout;
use App\Http\Controllers\backend\apps\EcommerceSettingsDetails;
use App\Http\Controllers\backend\apps\EcommerceSettingsLocations;
use App\Http\Controllers\backend\apps\EcommerceSettingsNotifications;
use App\Http\Controllers\backend\apps\EcommerceSettingsPayments;
use App\Http\Controllers\backend\apps\EcommerceSettingsShipping;
use App\Http\Controllers\backend\apps\Email;
use App\Http\Controllers\backend\apps\InvoiceAdd;
use App\Http\Controllers\backend\apps\InvoiceEdit;
use App\Http\Controllers\backend\apps\InvoiceList;
use App\Http\Controllers\backend\apps\InvoicePreview;
use App\Http\Controllers\backend\apps\InvoicePrint;
use App\Http\Controllers\backend\apps\Kanban;
use App\Http\Controllers\backend\apps\LogisticsDashboard;
use App\Http\Controllers\backend\apps\LogisticsFleet;
use App\Http\Controllers\backend\apps\UserList;
use App\Http\Controllers\backend\apps\UserViewAccount;
use App\Http\Controllers\backend\apps\UserViewBilling;
use App\Http\Controllers\backend\apps\UserViewConnections;
use App\Http\Controllers\backend\apps\UserViewNotifications;
use App\Http\Controllers\backend\apps\UserViewSecurity;
use App\Http\Controllers\backend\authentications\ForgotPasswordBasic;
use App\Http\Controllers\backend\authentications\ForgotPasswordCover;
use App\Http\Controllers\backend\authentications\LoginBasic;
use App\Http\Controllers\backend\authentications\LoginCover;
use App\Http\Controllers\backend\authentications\RegisterBasic;
use App\Http\Controllers\backend\authentications\RegisterCover;
use App\Http\Controllers\backend\authentications\RegisterMultiSteps;
use App\Http\Controllers\backend\authentications\ResetPasswordBasic;
use App\Http\Controllers\backend\authentications\ResetPasswordCover;
use App\Http\Controllers\backend\authentications\TwoStepsBasic;
use App\Http\Controllers\backend\authentications\TwoStepsCover;
use App\Http\Controllers\backend\authentications\VerifyEmailBasic;
use App\Http\Controllers\backend\authentications\VerifyEmailCover;
use App\Http\Controllers\backend\cards\CardActions;
use App\Http\Controllers\backend\cards\CardAdvance;
use App\Http\Controllers\backend\cards\CardAnalytics;
use App\Http\Controllers\backend\cards\CardBasic;
use App\Http\Controllers\backend\cards\CardStatistics;
use App\Http\Controllers\backend\charts\ApexCharts;
use App\Http\Controllers\backend\charts\ChartJs;
use App\Http\Controllers\backend\dashboard\Analytics;
use App\Http\Controllers\backend\dashboard\Crm;
use App\Http\Controllers\backend\extended_ui\Avatar;
use App\Http\Controllers\backend\extended_ui\BlockUI;
use App\Http\Controllers\backend\extended_ui\DragAndDrop;
use App\Http\Controllers\backend\extended_ui\MediaPlayer;
use App\Http\Controllers\backend\extended_ui\Misc;
use App\Http\Controllers\backend\extended_ui\PerfectScrollbar;
use App\Http\Controllers\backend\extended_ui\StarRatings;
use App\Http\Controllers\backend\extended_ui\SweetAlert;
use App\Http\Controllers\backend\extended_ui\TextDivider;
use App\Http\Controllers\backend\extended_ui\TimelineBasic;
use App\Http\Controllers\backend\extended_ui\TimelineFullscreen;
use App\Http\Controllers\backend\extended_ui\Tour;
use App\Http\Controllers\backend\extended_ui\Treeview;
use App\Http\Controllers\backend\form_elements\BasicInput;
use App\Http\Controllers\backend\form_elements\CustomOptions;
use App\Http\Controllers\backend\form_elements\Editors;
use App\Http\Controllers\backend\form_elements\Extras;
use App\Http\Controllers\backend\form_elements\FileUpload;
use App\Http\Controllers\backend\form_elements\InputGroups;
use App\Http\Controllers\backend\form_elements\Picker;
use App\Http\Controllers\backend\form_elements\Selects;
use App\Http\Controllers\backend\form_elements\Sliders;
use App\Http\Controllers\backend\form_elements\Switches;
use App\Http\Controllers\backend\form_layouts\HorizontalForm;
use App\Http\Controllers\backend\form_layouts\StickyActions;
use App\Http\Controllers\backend\form_layouts\VerticalForm;
use App\Http\Controllers\backend\form_validation\Validation;
use App\Http\Controllers\backend\form_wizard\Icons as FormWizardIcons;
use App\Http\Controllers\backend\form_wizard\Numbered as FormWizardNumbered;
use App\Http\Controllers\backend\front_pages\Checkout;
use App\Http\Controllers\backend\front_pages\HelpCenter;
use App\Http\Controllers\backend\front_pages\HelpCenterArticle;
use App\Http\Controllers\backend\front_pages\Landing;
use App\Http\Controllers\backend\front_pages\Payment;
use App\Http\Controllers\backend\front_pages\Pricing;
use App\Http\Controllers\backend\icons\FontAwesome;
use App\Http\Controllers\backend\icons\Tabler;
use App\Http\Controllers\backend\language\LanguageController;
use App\Http\Controllers\backend\laravel_example\UserManagement;
use App\Http\Controllers\backend\layouts\Blank;
use App\Http\Controllers\backend\layouts\CollapsedMenu;
use App\Http\Controllers\backend\layouts\Container;
use App\Http\Controllers\backend\layouts\ContentNavbar;
use App\Http\Controllers\backend\layouts\ContentNavSidebar;
use App\Http\Controllers\backend\layouts\Fluid;
use App\Http\Controllers\backend\layouts\Horizontal;
use App\Http\Controllers\backend\layouts\Vertical;
use App\Http\Controllers\backend\layouts\WithoutMenu;
use App\Http\Controllers\backend\layouts\WithoutNavbar;
use App\Http\Controllers\backend\maps\Leaflet;
use App\Http\Controllers\backend\modal\ModalExample;
use App\Http\Controllers\backend\pages\AccountSettingsAccount;
use App\Http\Controllers\backend\pages\AccountSettingsBilling;
use App\Http\Controllers\backend\pages\AccountSettingsConnections;
use App\Http\Controllers\backend\pages\AccountSettingsNotifications;
use App\Http\Controllers\backend\pages\AccountSettingsSecurity;
use App\Http\Controllers\backend\pages\Faq;
use App\Http\Controllers\backend\pages\MiscComingSoon;
use App\Http\Controllers\backend\pages\MiscError;
use App\Http\Controllers\backend\pages\MiscNotAuthorized;
use App\Http\Controllers\backend\pages\MiscUnderMaintenance;
use App\Http\Controllers\backend\pages\Pricing as PagesPricing;
use App\Http\Controllers\backend\pages\UserConnections;
use App\Http\Controllers\backend\pages\UserProfile;
use App\Http\Controllers\backend\pages\UserProjects;
use App\Http\Controllers\backend\pages\UserTeams;
use App\Http\Controllers\backend\tables\Basic as TablesBasic;
use App\Http\Controllers\backend\tables\DatatableAdvanced;
use App\Http\Controllers\backend\tables\DatatableBasic;
use App\Http\Controllers\backend\tables\DatatableExtensions;
use App\Http\Controllers\backend\user_interface\Accordion;
use App\Http\Controllers\backend\user_interface\Alerts;
use App\Http\Controllers\backend\user_interface\Badges;
use App\Http\Controllers\backend\user_interface\Buttons;
use App\Http\Controllers\backend\user_interface\Carousel;
use App\Http\Controllers\backend\user_interface\Collapse;
use App\Http\Controllers\backend\user_interface\Dropdowns;
use App\Http\Controllers\backend\user_interface\Footer;
use App\Http\Controllers\backend\user_interface\ListGroups;
use App\Http\Controllers\backend\user_interface\Modals;
use App\Http\Controllers\backend\user_interface\Navbar;
use App\Http\Controllers\backend\user_interface\Offcanvas;
use App\Http\Controllers\backend\user_interface\PaginationBreadcrumbs;
use App\Http\Controllers\backend\user_interface\Progress;
use App\Http\Controllers\backend\user_interface\Spinners;
use App\Http\Controllers\backend\user_interface\TabsPills;
use App\Http\Controllers\backend\user_interface\Toasts;
use App\Http\Controllers\backend\user_interface\TooltipsPopovers;
use App\Http\Controllers\backend\user_interface\Typography;
use App\Http\Controllers\backend\wizard_example\Checkout as WizardCheckout;
use App\Http\Controllers\backend\wizard_example\CreateDeal;
use App\Http\Controllers\backend\wizard_example\PropertyListing;
...
// Front Pages
Route::get('/front-pages/landing', [Landing::class, 'index'])->name('front-pagesf-landing');
...
Route::get('/app/ecommerce/product/category', [EcommerceProductCategory::class, 'list'])->name('app-ecommerce-product-category');
Route::resource('/category-list', EcommerceProductCategory::class);
